...
public class RewardFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().getWindow().setStatusBarColor(getResources().getColor(R.color.colorLightYello));
        ...
        rewardRecycler = view.findViewById(R.id.rewardrecycler);
        rewardRecycler.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.HORIZONTAL, true));
        rewardRecycler.setLayoutManager(new GridLayoutManager(getActivity(), 2));
